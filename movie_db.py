...
def init_database():
    ...
    c.execute("""CREATE TABLE IF NOT EXISTS movies
               ...
               plot TEXT,TEXT actors TEXT, awards TEXT, genre VARCHAR(80),
...
def print_movie_info(movie_data):
    print("    " + '#'*50)
    print("\t Movie Title :-  " +
          movie_data.get('Title', 'N/A').encode('utf-8', 'ignore'))
    print("\t Year  :-  " + movie_data.get('Year',
                                           'N/A').encode('utf-8', 'ignore'))
    print("\t IMDB Rating  :-  " + movie_data.get('imdbRating', 'N/A'))
    print("    " + '#'*50)


def print_not_found(movie):
    print("    " + 'x'*50)
    print("\t Found nothing about \"" + movie + "\"  !!.. Sorry :P")
